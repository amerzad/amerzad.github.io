 ...
 *
 */
function s(t,e){var i=this;i.DIRECTION_UP=1,i.DIRECTION_DOWN=2,i.DIRECTION_LEFT=4,i.DIRECTION_RIGHT=8,i.DIRECTION_UP_RIGHT=16,i.DIRECTION_UP_LEFT=32,i.DIRECTION_DOWN_RIGHT=64,i.DIRECTION_DOWN_LEFT=128,i.game=t,i.model=void 0!==e?e:null,i.dragLength=100,i.diagonalDelta=50,i.swiping=!1,i.direction=null,i.tmpDirection=null,i.tmpCallback=null,i.diagonalDisabled=!1,this.game.input.onDown.add(function(){i.swiping=!0}),this.game.input.onUp.add(function(){i.swiping=!1}),this.setupKeyboard()}s.prototype.setupKeyboard=function(){var t=this,e=this.game.input.keyboard.addKey(Phaser.Keyboard.UP);e.onDown.add(function(){if(null!==t.tmpDirection){switch(t.tmpDirection){case t.DIRECTION_LEFT:t.direction=t.DIRECTION_UP_LEFT,null!==t.model&&t.model.upLeft&&t.model.upLeft();break;case t.DIRECTION_RIGHT:t.direction=t.DIRECTION_UP_RIGHT,null!==t.model&&t.model.upRight&&t.model.upRight();break;default:t.direction=t.DIRECTION_UP,null!==t.model&&t.model.up&&t.model.up()}t.tmpDirection=null,t.tmpCallback=null}else t.tmpDirection=t.DIRECTION_UP,t.tmpCallback=null!==t.model&&t.model.up?t.model.up:null}),e.onUp.add(this.keyUp,this);var i=this.game.input.keyboard.addKey(Phaser.Keyboard.DOWN);i.onDown.add(function(){if(null!==t.tmpDirection){switch(t.tmpDirection){case t.DIRECTION_LEFT:t.direction=t.DIRECTION_DOWN_LEFT,null!==t.model&&t.model.downLeft&&t.model.downLeft();break;case t.DIRECTION_RIGHT:t.direction=t.DIRECTION_DOWN_RIGHT,null!==t.model&&t.model.downRight&&t.model.downRight();break;default:t.direction=t.DIRECTION_DOWN,null!==t.model&&t.model.down&&t.model.down()}t.tmpDirection=null,t.tmpCallback=null}else t.tmpDirection=t.DIRECTION_DOWN,t.tmpCallback=null!==t.model&&t.model.down?t.model.down:null}),i.onUp.add(this.keyUp,this);var s=this.game.input.keyboard.addKey(Phaser.Keyboard.LEFT);s.onDown.add(function(){if(null!==t.tmpDirection){switch(t.tmpDirection){case t.DIRECTION_UP:t.direction=t.DIRECTION_UP_LEFT,null!==t.model&&t.model.upLeft&&t.model.upLeft();break;case t.DIRECTION_DOWN:t.direction=t.DIRECTION_DOWN_LEFT,null!==t.model&&t.model.downLeft&&t.model.downLeft();break;default:t.direction=t.DIRECTION_LEFT,null!==t.model&&t.model.left&&t.model.left()}t.tmpDirection=null,t.tmpCallback=null}else t.tmpDirection=t.DIRECTION_LEFT,t.tmpCallback=null!==t.model&&t.model.left?t.model.left:null}),s.onUp.add(this.keyUp,this);var n=this.game.input.keyboard.addKey(Phaser.Keyboard.RIGHT);n.onDown.add(function(){if(null!==t.tmpDirection){switch(t.tmpDirection){case t.DIRECTION_UP:t.direction=t.DIRECTION_UP_RIGHT,null!==t.model&&t.model.upRight&&t.model.upRight();break;case t.DIRECTION_DOWN:t.direction=t.DIRECTION_DOWN_RIGHT,null!==t.model&&t.model.downRight&&t.model.downRight();break;default:t.direction=t.DIRECTION_RIGHT,null!==t.model&&t.model.right&&t.model.right()}t.tmpDirection=null,t.tmpCallback=null}else t.tmpDirection=t.DIRECTION_RIGHT,t.tmpCallback=null!==t.model&&t.model.right?t.model.right:null}),n.onUp.add(this.keyUp,this)},s.prototype.keyUp=function(){this.direction=this.tmpDirection,this.tmpDirection=null,null!==this.tmpCallback&&(this.tmpCallback.call(this.model),this.tmpCallback=null)},s.prototype.check=function(){if(null!==this.direction){var t={x:0,y:0,direction:this.direction};return this.direction=null,t}if(!this.swiping)return null;if(Phaser.Point.distance(this.game.input.activePointer.position,this.game.input.activePointer.positionDown)<this.dragLength)return null;this.swiping=!1;var e=null,i=this.game.input.activePointer.position.x-this.game.input.activePointer.positionDown.x,s=this.game.input.activePointer.position.y-this.game.input.activePointer.positionDown.y,t={x:this.game.input.activePointer.positionDown.x,y:this.game.input.activePointer.positionDown.y},n=Math.abs(i),r=Math.abs(s);return!this.diagonalDisabled&&n>this.dragLength-this.diagonalDelta&&r>this.dragLength-this.diagonalDelta?i>0&&s>0?(e=this.DIRECTION_DOWN_RIGHT,null!==this.model&&this.model.downRight&&this.model.downRight(t)):i>0&&s<0?(e=this.DIRECTION_UP_RIGHT,null!==this.model&&this.model.upRight&&this.model.upRight(t)):i<0&&s>0?(e=this.DIRECTION_DOWN_LEFT,null!==this.model&&this.model.downLeft&&this.model.downLeft(t)):i<0&&s<0&&(e=this.DIRECTION_UP_LEFT,null!==this.model&&this.model.upLeft&&this.model.upLeft(t)):(n>this.dragLength||r>this.dragLength)&&(n>r?i>0?(e=this.DIRECTION_RIGHT,null!==this.model&&this.model.right&&this.model.right(t)):i<0&&(e=this.DIRECTION_LEFT,null!==this.model&&this.model.left&&this.model.left(t)):s>0?(e=this.DIRECTION_DOWN,null!==this.model&&this.model.down&&this.model.down(t)):s<0&&(e=this.DIRECTION_UP,null!==this.model&&this.model.up&&this.model.up(t))),null!==e?(t.direction=e,t):null},void 0!==t&&t.exports&&(t.exports=s)},function(t,e){function i(){throw new Error("setTimeout has not been defined")}function s(){throw new Error("clearTimeout has not been defined")}function n(t){if(c===setTimeout)return setTimeout(t,0);if((c===i||!c)&&setTimeout)return c=setTimeout,setTimeout(t,0);try{return c(t,0)}catch(e){try{return c.call(null,t,0)}catch(e){return c.call(this,t,0)}}}function r(t){if(u===clearTimeout)return clearTimeout(t);if((u===s||!u)&&clearTimeout)return u=clearTimeout,clearTimeout(t);try{return u(t)}catch(e){try{return u.call(null,t)}catch(e){return u.call(this,t)}}}function o(){g&&p&&(g=!1,p.length?f=p.concat(f):m=-1,f.length&&a())}function a(){if(!g){var t=n(o);g=!0;for(var e=f.length;e;){for(p=f,f=[];++m<e;)p&&p[m].run();m=-1,e=f.length}p=null,g=!1,r(t)}}function h(t,e){this.fun=t,this.array=e}function l(){}var c,u,d=t.exports={};!function(){try{c="function"==typeof setTimeout?setTimeout:i}catch(t){c=i}try{u="function"==typeof clearTimeout?clearTimeout:s}catch(t){u=s}}();var p,f=[],g=!1,m=-1;d.nextTick=function(t){var e=new Array(arguments.length-1);if(arguments.length>1)for(var i=1;i<arguments.length;i++)e[i-1]=arguments[i];f.push(new h(t,e)),1!==f.length||g||n(a)},h.prototype.run=function(){this.fun.apply(null,this.array)},d.title="browser",d.browser=!0,d.env={},d.argv=[],d.version="",d.versions={},d.on=l,d.addListener=l,d.once=l,d.off=l,d.removeListener=l,d.removeAllListeners=l,d.emit=l,d.binding=function(t){throw new Error("process.binding is not supported")},d.cwd=function(){return"/"},d.chdir=function(t){throw new Error("process.chdir is not supported")},d.umask=function(){return 0}},function(t,e,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0});var s=i(0),n=function(){function t(){}return t.loadImages=function(){for(var t in s.Images)if(!this.game.cache.checkImageKey(s.Images[t].getName()))for(var e in s.Images[t])"getName"!==e&&this.game.load.image(s.Images[t].getName(),s.Images[t][e]())},t.loadSpritesheets=function(){for(var t in s.Spritesheets)if(!this.game.cache.checkImageKey(s.Spritesheets[t].getName())){var e=null;for(var i in s.Spritesheets[t])"getName"!==i&&"getFrameWidth"!==i&&"getFrameHeight"!==i&&"getFrameMax"!==i&&"getMargin"!==i&&"getSpacing"!==i&&(e=i);this.game.load.spritesheet(s.Spritesheets[t].getName(),s.Spritesheets[t][e](),s.Spritesheets[t].getFrameWidth(),s.Spritesheets[t].getFrameHeight(),s.Spritesheets[t].getFrameMax(),s.Spritesheets[t].getMargin(),s.Spritesheets[t].getSpacing())}},t.loadAtlases=function(){for(var t in s.Atlases)if(!this.game.cache.checkImageKey(s.Atlases[t].getName())){var e=null,i=null;for(var n in s.Atlases[t])"getXML"===n||"getJSONArray"===n||"getJSONHash"===n?i=n:"getName"!==n&&"Frames"!==n&&(e=n);"getXML"===i?this.game.load.atlasXML(s.Atlases[t].getName(),s.Atlases[t][e](),s.Atlases[t].getXML()):"getJSONArray"===i?this.game.load.atlasJSONArray(s.Atlases[t].getName(),s.Atlases[t][e](),s.Atlases[t].getJSONArray()):"getJSONHash"===i&&this.game.load.atlasJSONHash(s.Atlases[t].getName(),s.Atlases[t][e](),s.Atlases[t].getJSONHash())}},t.orderAudioSourceArrayBasedOnSoundExtensionPreference=function(t){var e=this,i=[];for(var s in this.soundExtensionsPreference){var n=t.filter(function(t){return t.substring(t.lastIndexOf(".")+1,t.length)===e.soundExtensionsPreference[s]});i=i.concat(n)}return i},t.loadAudio=function(){for(var t in s.Audio){var e=s.Audio[t].getName();if(this.soundKeys.push(e),!this.game.cache.checkSoundKey(e)){var i=[];for(var n in s.Audio[t])"getName"!==n&&i.push(s.Audio[t][n]());i=this.orderAudioSourceArrayBasedOnSoundExtensionPreference(i),this.game.load.audio(e,i,!0)}}},t.loadAudiosprites=function(){for(var t in s.Audiosprites){var e=s.Audiosprites[t].getName();if(this.soundKeys.push(e),!this.game.cache.checkSoundKey(e)){var i=[];for(var n in s.Audiosprites[t])"getName"!==n&&"getJSON"!==n&&"Sprites"!==n&&i.push(s.Audiosprites[t][n]());i=this.orderAudioSourceArrayBasedOnSoundExtensionPreference(i),this.game.load.audiosprite(e,i,s.Audiosprites[t].getJSON(),null,!0)}}},t.loadBitmapFonts=function(){for(var t in s.BitmapFonts)if(!this.game.cache.checkBitmapFontKey(s.BitmapFonts[t].getName())){var e=null,i=null;for(var n in s.BitmapFonts[t])"getXML"===n||"getFNT"===n?i=n:"getName"!==n&&(e=n);this.game.load.bitmapFont(s.BitmapFonts[t].getName(),s.BitmapFonts[t][e](),s.BitmapFonts[t][i]())}},t.loadJSON=function(){for(var t in s.JSON)this.game.cache.checkJSONKey(s.JSON[t].getName())||this.game.load.json(s.JSON[t].getName(),s.JSON[t].getJSON(),!0)},t.loadXML=function(){for(var t in s.XML)this.game.cache.checkXMLKey(s.XML[t].getName())||this.game.load.xml(s.XML[t].getName(),s.XML[t].getXML(),!0)},t.loadText=function(){for(var t in s.Text)this.game.cache.checkTextKey(s.Text[t].getName())||this.game.load.xml(s.Text[t].getName(),s.Text[t].getText(),!0)},t.loadScripts=function(){for(var t in s.Scripts)this.game.load.script(s.Scripts[t].getName(),s.Scripts[t].getJS())},t.loadShaders=function(){for(var t in s.Shaders)this.game.cache.checkShaderKey(s.Shaders[t].getName())||this.game.load.shader(s.Shaders[t].getName(),s.Shaders[t].getFRAG(),!0)},t.loadAllAssets=function(t,e,i){this.game=t,e&&this.game.load.onLoadComplete.addOnce(e,i),this.loadImages(),this.loadSpritesheets(),this.loadAtlases(),this.loadAudio(),this.loadAudiosprites(),this.loadBitmapFonts(),this.loadJSON(),this.loadXML(),this.loadText(),this.loadScripts(),this.loadShaders()},t.waitForSoundDecoding=function(t,e){this.soundKeys.length>0?this.game.sound.setDecodedCallback(this.soundKeys,t,e):t.call(e)},t}();n.game=null,n.soundKeys=[],n.soundExtensionsPreference=["webm","ogg","m4a","mp3","aac","ac3","caf","flac","mp4","wav"],e.Loader=n},function(t,e,i){"use strict";function s(){var t=800,e=500,i=l.ScreenUtils.calculateScreenMetrics(t,e);t=i.gameWidth,e=i.gameHeight;var s={width:t,height:e,renderer:Phaser.AUTO,parent:"",resolution:1};new u(s)}var n=this&&this.__extends||function(){var t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i])};return function(e,i){function s(){this.constructor=e}t(e,i),e.prototype=null===i?Object.create(i):(s.prototype=i.prototype,new s)}}();Object.defineProperty(e,"__esModule",{value:!0}),i(5),i(3),i(4);var r=i(9),o=i(6),a=i(7),h=i(8),l=i(2),c=i(0),u=function(t){function e(e){var i=t.call(this,e)||this;return i.state.add("boot",o.default),i.state.add("preloader",a.default),i.state.add("title",h.default),i.state.start("boot"),i}return n(e,t),e}(Phaser.Game);window.onload=function(){var t=null,e=["Barrio"];if(e.length>0&&(t=t||{},t.google={families:e}),Object.keys(c.CustomWebFonts).length>0){t=t||{},t.custom={families:[],urls:[]};for(var i in c.CustomWebFonts)t.custom.families.push(c.CustomWebFonts[i].getFamily()),t.custom.urls.push(c.CustomWebFonts[i].getCSS())}null===t?s():(t.active=s,r.load(t))}}]);